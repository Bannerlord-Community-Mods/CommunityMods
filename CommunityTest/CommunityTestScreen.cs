...
{
    public class CommunityTestScreen : ScreenBase
    {
        private CommunityTestVM _datasource;
        ...
        {
            base.OnInitialize();
            this._datasource = new CommunityTestVM();
            ...
            this._movie = this._gauntletLayer.LoadMovie("CommunityTestScreen", (ViewModel)this._datasource);
