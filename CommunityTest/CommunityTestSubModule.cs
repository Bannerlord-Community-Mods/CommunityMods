...
{
    public class CommunityTestSubModule : TaleWorlds.MountAndBlade.MBSubModuleBase
    {
        private static CommunityTestSubModule _instance;
        private bool _initialized;
        protected override void OnSubModuleLoad()
        {
            base.OnSubModuleLoad();
            ModuleLogger.Writer.WriteLine("CaptureTheBannerLordSubModule::OnSubModuleLoad");
            CommunityTestSubModule._instance = this;
            Module.CurrentModule.AddInitialStateOption(new InitialStateOption(
              "CaptureTheBannerLord",
              new TextObject("{=CaptureTheBannerLord}Battle Test", (Dictionary<string, TextObject>)null),
              10001,
              () => ScreenManager.PushScreen(new CommunityTestScreen()),
              false
            ));
        }
        ...
        protected override void OnSubModuleUnloaded()
        {
            ...
            CommunityTestSubModule._instance = (CommunityTestSubModule)null;
